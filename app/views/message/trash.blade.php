                    ...
                    <li class="b-message-ls-mark__list b-message-ls-mark__list_border-right">
                        <div class="b-message-ls-mark-button">
                            ...
                            <div class="b-message-ls-mark-button-list dropdown-list">
                                <ul>
                                    <li class="b-message-ls-mark-button-list__item"><a onclick="message.setAction('restore', this);" style="cursor: pointer;">Восстановить</a></li>
                                    <li class="b-message-ls-mark-button-list__item"><a onclick="message.setAction('force_delete', this);" style="cursor: pointer;">Удалить навсегда</a></li>
                                    <li class="b-message-ls-mark-button-list__item"><a onclick="message.setAction('blacklist', this);" style="cursor: pointer;">Заблокировать</a></li>
                                </ul>
                            </div>
