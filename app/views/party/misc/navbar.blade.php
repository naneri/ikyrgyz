						...
						<div class="b-topic-navigation-menu">
							<div class="b-topic-navigation-menu__list">
								<dl class="dropdown-list">
									<dt class="title"><a href="{{ URL::to('/') }}" class="soc-name"></a></dt>
				...
				<ul class="b-header-nav-list">
					<li class="b-header-nav__left">
						<div class="b-header-nav-logo">
							<div class="b-header-nav-logo__item"><a href="{{ URL::to('/') }}"><img src="{{ asset('img/party/1.png') }}"  alt="logo"/></a></div>
							
						</div>
						<div class="b-header-nav-text">
							<p>Партиясы</p>
							<p>Мекен Ытымагы</p>
						</div>
                   ...
                   @endif -->
					...
					<li class="b-header-nav__right">
					 @if(@Auth::check())
                          ...
                          <div class="b-header-nav-user__counter">
                          	<div class="b-header-nav-user-button">
                          		<ul>
                          			<li class="b-header-nav-user-button__list"><a href="">
                          				<img src="{{ asset('img/party/2.png') }}" alt="msg"/>
										<span class="counter"></span>
                          			</a></li>
                          			<li class="b-header-nav-user-button__list"><a href="">
                          				<img src="{{ asset('img/party/3.png') }}" alt="msg"/>
										<span class="counter"></span>
                          			</a></li>
                          			<li class="b-header-nav-user-button__list"><a href="">
                          				 <img src="{{ asset('img/party/4.png') }}" alt="msg"/>
                                		<span class="counter"></span>
                          			</a></li>
                          		</ul>
                          	</div>
