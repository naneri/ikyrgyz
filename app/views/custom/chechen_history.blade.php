                        ...
                        <div class="b-profile-about__text">
                            <div class="b-profile-about-text">
                                <div class="b-profile-about-text__text">
                                    ...
                                    <br/><br/>
                                    <img src="{{ URL::to('img/custom/chechen_history_1.jpg') }}" style="width: 100%"/>
                                    <br/><br/>
                                    ...
                                    <br/><br/>
                                    <h2>Чечня в составе Российской империи</h2>
                                    <br/>
                                    ...
                                    <br/><br/>
                                    <img src="{{ URL::to('img/custom/chechen_history_2.jpg') }}" style="width: 100%"/>
                                </div>
                            </div>
                        </div>
                    </div>
