                        ...
                        <div class="b-profile-about__text">
                            <div class="b-profile-about-text">
                                <div class="b-profile-about-text__text">
                                    ...
                                    <br/>
                                    <img src="{{ URL::to('img/custom/history_1.jpg') }}" style="width: 100%"/>
                                    <br/><br/>
                                    ...
                                    <br/><br/>
                                    <img src="{{ URL::to('img/custom/history_2.png') }}" style="width: 100%"/>
                                    <br/><br/>
                                    ...
                                    <br/>
                                    <img src="{{ URL::to('img/custom/history_3.jpg') }}" style="width: 100%"/>
                                    <br/><br/>
