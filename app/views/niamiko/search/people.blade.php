                    ...
                    <div class="b-user-interface-content-wrapper">
                        <div class="b-user-interface-content-nav">
                            <ul class="tabs">
                                ...
                                <li data-tab="tab-2" class="b-user-interface-content-nav__list tab-link current"><a class="tabCurrentLink" href="{{URL::to('search/people')}}@if($search_text){{'?search-text='.$search_text}}@endif">{{ trans('network.people') }}</a></li>
