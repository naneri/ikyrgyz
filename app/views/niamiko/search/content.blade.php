                    ...
                    <div class="b-user-interface-content-wrapper">
                        <div class="b-user-interface-content-nav">
                            <ul class="tabs">
                                ...
                                <li data-tab="tab-3" class="b-user-interface-content-nav__list tab-link current"><a class="tabCurrentLink" href="{{URL::to('search/content')}}@if($search_text){{'?search-text='.$search_text}}@endif">{{ trans('network.content') }}</a></li>
